 ...
 */
const getAdditionOperands = (numsNeeded: number): OperandInfo => {
    ...
    return {
        targetNum: target,
        mainOperands: operands,
        allOperands: allNumbers,
        operator: OperatorType.Addition,
    };
};

const getSubtractionOperands = (numsNeeded: number): OperandInfo => {
...
const getDivisionOperands = (numsNeeded: number): OperandInfo => {
...
const getMultiplicationOperands = (numsNeeded: number): OperandInfo => {
    const maxNum = 100;
